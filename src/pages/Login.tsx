    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0d1627] text-slate-200" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="w-full max-w-md relative z-10 px-6">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm text-center">Enter your details to continue your learning journey.</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link to="/register" className="font-semibold text-white hover:text-cyan-400 transition-colors">Sign up</Link>
        </p>
      </div>
    </div>
  );
